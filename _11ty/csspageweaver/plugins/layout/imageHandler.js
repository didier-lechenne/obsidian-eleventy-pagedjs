...
export class imageHandler {
  ...
  handleArrowKeys(e) {
    ...
    // Zoom avec + et -
    // const zoomActions = {
    //     'Equal': 1.02,      // Shift + = donne + (+2%)
    //     'Minus': 0.98,      // Shift + - (-2%)
    //     'NumpadAdd': 1.02,  // + du pavé numérique
    //     'NumpadSubtract': 0.98 // - du pavé numérique
    // };

    // const zoomActions = {
    //     'Equal': 1.01,      // Shift + = donne + (+1%)
    //     'Minus': 0.99,      // Shift + - (-1%)
    //     'NumpadAdd': 1.01,  // + du pavé numérique
    //     'NumpadSubtract': 0.99 // - du pavé numérique
    // };

    const zoomActions = {
        'Equal': 1.005,      // Shift + = donne + (+0.5%)
        'Minus': 0.995,      // Shift + - (-0.5%)
        'NumpadAdd': 1.005,  // + du pavé numérique
        'NumpadSubtract': 0.995 // - du pavé numérique
    };
